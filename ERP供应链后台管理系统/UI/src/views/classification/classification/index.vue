<template>
  <div class="app-container">
    <el-form
      ...
      label-width="96px"
    >
      <el-form-item label="设备分类名称" prop="classificationName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['classification:classification:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['classification:classification:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['classification:classification:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['classification:classification:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
...
} from "../../../api/classification/classification";
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map((item) => item.classificationId);
    ...
    handleUpdate(row) {
      this.reset();
      const classificationId = row.classificationId || this.ids;
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const classificationIds = row.classificationId || this.ids;
      this.$modal
        .confirm(
          '是否确认删除设备分类编号为"' + classificationIds + '"的数据项？'
        )
        .then(function () {
